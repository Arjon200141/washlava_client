...
const Faq = () => {
    return (
        <div className='m-12'>
            <h2 className='text-center text-gray-700 text-5xl font-semibold'>Frequently Asked Questions (FAQ)</h2>
            ...
            <div className='flex gap-8 manrope'>
                ...
                <div className='flex-1'>
                    <img src="https://i.ibb.co.com/M57bY7rT/faq.jpg" alt="" className='h-[600px]'/>
                </div>
            </div>
        </div>
    );
