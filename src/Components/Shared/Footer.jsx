...
const Footer = () => {
    return (
        <div className="">
            <footer className="footer grid grid-cols-3 gap-6 bg-[#6d96f6] text-base-content p-10">
                <nav className="ml-16">
                    ...
                    <div className="mt-3 ml-3">
                        ...
                        <a className="link epilogue text-[17px] font-normal link-hover flex items-center gap-4 mb-3"><span className="text-black text-md"><CiMail /></span>contact@hirely.com</a>
            ...
            <footer className="footer footer-center bg-[#3370fc] text-black text-xl p-4">
                <aside>
